...
internal class LeftFallingObstacle : GameObject
{
    ...
    public LeftFallingObstacle(Scene scene, Transform transform) : base(scene, transform)
    {
        ...
        // If the client ID is less than the opponent ID, add a collision component
